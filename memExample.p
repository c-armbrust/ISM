...
#define INS_PER_DELAY_LOOP 2     // two instructions per delay loop
                                 // set up a 50ms delay
//#define DELAY  50 * 1000 * (INS_PER_US / INS_PER_DELAY_LOOP) // 50ms delay
//#define DELAY 10 * (INS_PER_US / INS_PER_DELAY_LOOP) // 10us delay 

// 50 => 500ns (1 instruction = 5ns und 2 INS pro loop)
#define DELAY 50 

#define DELAY2 10 * (INS_PER_US / INS_PER_DELAY_LOOP) // 10us delay
